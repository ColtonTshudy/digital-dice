...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_RS_Pin|LCD_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_RST_Pin|BACKLIGHT_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_RS_Pin LCD_RST_Pin BACKLIGHT_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = LCD_RS_Pin|LCD_RST_Pin|BACKLIGHT_Pin|LCD_CS_Pin;
