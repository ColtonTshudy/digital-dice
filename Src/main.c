...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_RST_Pin|LCD_BL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_RS_Pin LCD_RST_Pin LCD_BL_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = LCD_RS_Pin|LCD_RST_Pin|LCD_BL_Pin|LCD_CS_Pin;
